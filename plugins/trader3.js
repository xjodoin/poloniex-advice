...
var previousAdvice;
var fee = config.fee;
var buyDiffTrigger = config.buyDiffTrigger;
var sellDiffTrigger = config.sellDiffTrigger;
var lastSell = {};
  ...
  adviceEventEmiter.on('advice', function(advice) {
    ...
    walletService.loadWallet(function(err, wallet) {
      ...
      if (advice.type === 'sell' && wallet.currencyValue > 0.0001) {
        ...
        if (profitBtc > 0 || diff > sellDiffTrigger) {
        ...
        if (profitCurrency > 0 || diff > buyDiffTrigger) {
